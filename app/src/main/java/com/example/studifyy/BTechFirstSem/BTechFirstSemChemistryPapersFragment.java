...
public class BTechFirstSemChemistryPapersFragment extends Fragment {
    RecyclerView recyclerView;
    ArrayList<LoadMaterialModal> list;
    public BTechFirstSemChemistryPapersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_b_tech_first_sem_chemistry_papers, container, false);
        list=new ArrayList<>();
        recyclerView=view.findViewById(R.id.ChemistryPapersRecycleView);
