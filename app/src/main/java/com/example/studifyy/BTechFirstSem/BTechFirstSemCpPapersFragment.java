...
public class BTechFirstSemCpPapersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view= inflater.inflate(R.layout.fragment_b_tech_first_sem_cp_papers, container, false);
        list=new ArrayList<>();
       recyclerView=view.findViewById(R.id.CPpapersRecycleview);
