...
public class BTechFirstSemPhysicsLabFragment extends Fragment {
    RecyclerView recyclerView;
    ArrayList<LoadMaterialModal> list;
    ShimmerFrameLayout shimmerFrameLayout;

    public BTechFirstSemPhysicsLabFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view=inflater.inflate(R.layout.fragment_b_tech_first_sem_physics_lab, container, false);
        shimmerFrameLayout=view.findViewById(R.id.shimmer);
        shimmerFrameLayout.startShimmer();
        list=new ArrayList<>();
        recyclerView=view.findViewById(R.id.PhysicsLabRecycleView);
