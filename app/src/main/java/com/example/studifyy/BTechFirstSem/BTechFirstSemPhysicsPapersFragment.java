...
public class BTechFirstSemPhysicsPapersFragment extends Fragment {
    private String mParam2;
    RecyclerView recyclerView;
    ArrayList<LoadMaterialModal> list;


    public BTechFirstSemPhysicsPapersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_b_tech_first_sem_physics_papers, container, false);
        list=new ArrayList<>();
        recyclerView=view.findViewById(R.id.PhysicsPapersRecycleView);
