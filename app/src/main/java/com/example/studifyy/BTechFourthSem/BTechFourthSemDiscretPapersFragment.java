...
public class BTechFourthSemDiscretPapersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_b_tech_fourth_sem_discret_papers, container, false);
        list=new ArrayList<>();
        recyclerView=view.findViewById(R.id.DiscretPapersRecycleView);
