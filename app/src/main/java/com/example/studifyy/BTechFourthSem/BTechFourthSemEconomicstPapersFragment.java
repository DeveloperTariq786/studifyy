...
public class BTechFourthSemEconomicstPapersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_b_tech_fourth_sem_economicst_papers, container, false);
        list=new ArrayList<>();
        recyclerView=view.findViewById(R.id.EconomicstPapersRecycleView);
