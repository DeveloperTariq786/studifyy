...
public class BTechSecondSemElectricalPapersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_b_tech_second_sem_electrical_papers, container, false);
        list=new ArrayList<>();
        recyclerView=view.findViewById(R.id.ElectricalPapersRecycleView);
