...
public class BTechSecondSemMathNotesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_b_tech_second_sem_math_notes, container, false);
        ...
        FirebaseDatabase.getInstance().getReference().child("BTechSecondSemMathNotes").addValueEventListener(new ValueEventListener() {
            @Override
