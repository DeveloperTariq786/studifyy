...
public class BTechSecondSemMechanicsPapersFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_b_tech_second_sem_mechanics_papers, container, false);
        list=new ArrayList<>();
        recyclerView=view.findViewById(R.id.MechanicsPapersRecycleView);
