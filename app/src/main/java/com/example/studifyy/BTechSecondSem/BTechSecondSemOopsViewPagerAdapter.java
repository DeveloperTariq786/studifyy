...
public class BTechSecondSemOopsViewPagerAdapter extends FragmentPagerAdapter {
    public BTechSecondSemOopsViewPagerAdapter(@NonNull FragmentManager fm) {
        super(fm);
    }
    ...
    public Fragment getItem(int position) {
        if(position==0){
            return new BTechSecondSemOopsBooksFragment();
        }
        else {
            return new BTechSecondSemOopsNotesFragment();
        }
