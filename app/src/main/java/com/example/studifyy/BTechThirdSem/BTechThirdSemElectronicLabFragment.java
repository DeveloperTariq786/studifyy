...
public class BTechThirdSemElectronicLabFragment extends Fragment {
    RecyclerView recyclerView;
    ArrayList<LoadMaterialModal> list;


    public BTechThirdSemElectronicLabFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view= inflater.inflate(R.layout.fragment_b_tech_third_sem_electronic_lab, container, false);
        list=new ArrayList<>();
        recyclerView=view.findViewById(R.id.electronicLabRecycleView);
