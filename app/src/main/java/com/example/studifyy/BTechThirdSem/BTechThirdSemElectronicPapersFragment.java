...
public class BTechThirdSemElectronicPapersFragment extends Fragment {
    RecyclerView recyclerView;
    ArrayList<LoadMaterialModal> list;

    public BTechThirdSemElectronicPapersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_b_tech_third_sem_electronic_papers, container, false);
        list=new ArrayList<>();
        recyclerView=view.findViewById(R.id.ElectronicpapersRecycleView);
