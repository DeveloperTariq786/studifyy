...
public class BtechThirdSemMathBBooksFragment extends Fragment {
    RecyclerView recyclerView;
    ArrayList<LoadMaterialModal> list;
    public BtechThirdSemMathBBooksFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_btech_third_sem_math_b_books, container, false);
        list=new ArrayList<>();
