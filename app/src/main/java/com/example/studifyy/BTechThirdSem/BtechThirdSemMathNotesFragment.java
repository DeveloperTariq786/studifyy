...
public class BtechThirdSemMathNotesFragment extends Fragment {
    RecyclerView recyclerView;
    ArrayList<LoadMaterialModal> list;
    ShimmerFrameLayout shimmerFrameLayout;
    public BtechThirdSemMathNotesFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view= inflater.inflate(R.layout.fragment_btech_third_sem_math_notes, container, false);
        ...
        FirebaseDatabase.getInstance().getReference().child("BTechThirdSemMathNotes").addValueEventListener(new ValueEventListener() {
            @Override
