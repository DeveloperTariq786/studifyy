...
public class BtechThirdSemMathPapersFragment extends Fragment {
    RecyclerView recyclerView;
    TextView collection;
    ShimmerFrameLayout shimmerFrameLayout;
    ArrayList<LoadMaterialModal> list;
    public BtechThirdSemMathPapersFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view= inflater.inflate(R.layout.fragment_btech_third_sem_math_papers, container, false);
        shimmerFrameLayout=view.findViewById(R.id.shimmer);
        shimmerFrameLayout.startShimmer();
        list=new ArrayList<>();
        recyclerView=view.findViewById(R.id.mathpapersRecycleView);
